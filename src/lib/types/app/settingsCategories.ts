import { UserRound, ShieldCheck, NotebookPen, ArrowDownUp, Info, Database } from '@lucide/svelte';
...
const settingsCategories = [
	...
	{ id: 'data', desc: 'export, import, purge', icon: Database },
	{ id: 'sync', desc: 'synchronization, status', icon: ArrowDownUp },
