export default function CookiePolicy() {
  return (
    <main className="mx-auto max-w-4xl px-8 py-16 lg:py-24">
      <h1 className="text-foreground mb-8 text-6xl font-bold">cookie policy</h1>
      ...
      <div className="space-y-12">
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            remember information about you. they&apos;re a standard part of how
          ...
          <div className="ml-6 space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                keeps you logged in so you don&apos;t have to sign in every time
                you visit shelter. without this cookie, you&apos;d need to log
                in on every page.
              </p>
            </div>
            <div>
              ...
              <p className="text-muted-foreground">
                remembers your preferences and settings during your visit, like
                your theme choice or language preference.
              </p>
            </div>
            <div>
              <p className="text-foreground font-semibold">
              ...
              <p className="text-muted-foreground">
                helps protect your account from unauthorized access and ensures
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            save your encrypted entries on your device. this is not the same as
            cookies and gives you offline access to your content.
          </p>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            work properly. you won&apos;t be able to stay logged in or save your
            preferences.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            update this policy and let you know. we&apos;re committed to keeping
            cookie usage to the absolute minimum.
          </p>
        </section>
