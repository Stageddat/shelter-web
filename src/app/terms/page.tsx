    ...
    <main className="mx-auto max-w-4xl px-8 py-16 lg:py-24">
      ...
      <div className="space-y-12">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            shelter is a private, encrypted space for your thoughts, notes, and
            reflections. it&apos;s designed to be a safe place where you can
            write freely without judgment or surveillance.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            strong password and don&apos;t share it with anyone. if you believe
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            everything you write in shelter belongs to you. we don&apos;t claim
            any ownership over your content. because your data is encrypted, we
            can&apos;t access it anyway.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            you&apos;re responsible for the content you create. while we
            can&apos;t see your entries, we ask that you use shelter responsibly
            and legally.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            guarantee it will be available 100% of the time. we may need to take
            the service down for maintenance or updates occasionally.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            since your data is stored locally on your device, you&apos;ll always
            have access to your entries even when shelter&apos;s sync service is
            down.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            while we take reasonable measures to keep your synced data safe, we
            recommend you regularly export your entries as a backup. you&apos;re
            responsible for maintaining your own backups of important content.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            being unable to use shelter. this includes data loss, even though we
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            changes, we&apos;ll notify you clearly and give you time to review
            them. continuing to use shelter after changes means you accept the
            new terms.
          </p>
        </section>
