...
<svelte:head>
	<title>{m['metadata.cookies.title']()}</title>
	<meta name="description" content={m['metadata.cookies.description']()} />
</svelte:head>

<Navbar />
<main class="mx-auto max-w-4xl px-8 py-20 lg:py-24">
	<BackToHome />
	<h1 class="mb-2 text-6xl font-bold text-foreground">{m['landing.cookies.title']()}</h1>
