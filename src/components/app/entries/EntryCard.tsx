  ...
  return (
    <>
      <AlertDialog open={showDialog} onOpenChange={setShowDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="text-3xl! tracking-wide">
              delete &quot;{entry.title}&quot; entry?
            </AlertDialogTitle>
            <AlertDialogDescription className="text-muted-foreground text-xl tracking-wide">
              this entry will be lost forever! (a long time!)
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel className="cursor-pointer text-lg! tracking-wide!">
              cancel
            </AlertDialogCancel>
            <AlertDialogAction
              variant="destructive"
              className="text-destructive! bg-destructive/20! hover:bg-destructive/30! cursor-pointer text-lg! tracking-wider!"
